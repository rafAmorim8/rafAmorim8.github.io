...
const renderSkillsElement = (name, percentage) => {
  // Finds the div where the buttons should be placed
  let skillsContainer = document.getElementById("skills-info");
  ...
  skillNames.forEach((name, i) => {
    ...
    skillPercent.classList.add("skill-percentage");
...
// Calls the function to create the elements
renderSkillsElement(skillNames, skillPercentages);
